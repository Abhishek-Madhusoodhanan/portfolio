            ...
            <div className="hero-container">
                <div className="hero-content">
                    ...
                    <h1 className="hero-name">
                        ...
                        <span className="last-name">Madhusoodhanan</span>
                    </h1>
                    ...
                    <p className="hero-description">
                        Passionate about building intelligent web applications and AI-powered solutions.
                        Experienced in Django, React, LangChain, and cutting-edge ML technologies.
                    </p>
